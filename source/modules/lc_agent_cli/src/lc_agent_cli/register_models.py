...
"""
NVIDIA model registration for LC Agent CLI.

This module registers NVIDIA models using the official langchain-nvidia-ai-endpoints integration.
"""
...
def register_all(verbose=False):
    """Register NVIDIA chat models for CLI usage."""
